...
export default function ModalCyberBugs(props) {
  ...
  const renderComment = () => {
    console.log('taskDetailModal.lstComment',taskDetailModal.lstComment)
    return taskDetailModal.lstComment?.map((comment,index)=>{
      
      let jsxComment = HtmlParser(comment.commentContent)
          ...
          {visibleComment ? (
            <div>
              ...
              <Editor
                ...
                onEditorChange={(content, editor) => {
                  let jsx = HtmlParser(content)
                  console.log(jsx[0].props.children[0])
                  setUpdateComment(jsx[0].props.children[0]);
                }}
              />
              <button
                className="btn btn-primary m-2"
            ...
            // onClick={() => {
            //   setHistoryContent(taskDetailModal.description);
            //   setVisibleComment(!visibleEditor);
            // }}
            >
              {/* {jsxDescription} */}
