...
import { USER_SIGNIN_API, USER_SIGNUP_API, USLOGIN } from '../../constants/Cyberbugs/Cyberbugs';
...
function* signupSaga(action) {
    ...
    //Gọi api 
    try {
        const { data, status } = yield call(() => cyberbugsService.signupCyberBugs(action.userSignup));
